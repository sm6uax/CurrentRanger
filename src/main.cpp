...
//***********************************************************************************************************
#define LDO_OUTPUT             3.297 //volts, change to actual LDO output (measure GND-3V on OLED header)
//***********************************************************************************************************
...
extern void adcCorrectionCheck();
extern void toggleAutoranging();
extern void WDTset();
extern void WDTclear(); 
extern void handleTouchPads();
extern void handleAutoOff();
extern void readVOUT();
extern void rangeUA();
extern void rangeNA();
extern void rangeMA();
extern int adcRead(byte);
extern void toggleOffset();
extern void Beep(byte, boolean);
extern void toggleLPF();
extern void calibrateADC();
extern uint16_t readGndLevel();
extern uint16_t read3V3Level();
